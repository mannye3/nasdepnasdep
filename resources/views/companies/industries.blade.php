...
@section('content')
 <!-- main header @e -->
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Industries</h3>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="580.00">
                                                                    ...
                                                                    <a class="btn btn-primary" href="" data-toggle="modal" data-target="#editModal-{{$industry->id}}">Edit</a>




                                                                    <a class="btn btn-danger" href="" data-toggle="modal" data-target="#deleteModal-{{ $industry->id}}">Delete</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('addIndustry')}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="summernote-basic" name="desc"></textarea>
    ...
    <!-- SHOW Modal Form -->
    <div class="modal fade" tabindex="-1" id="editModal-{{ $industry->id}}">
       <div class="modal-dialog" role="document">
           <div class="modal-content">
               <div class="modal-header">
                   <h5 class="modal-title">{{$industry->name}}</h5>
                   <a href="#" class="close" data-dismiss="modal" aria-label="Close">
                       <em class="icon ni ni-cross"></em>
                   </a>
               </div>
               <div class="modal-body">
               <form  method="POST" action="{{ route('editIndustry', $industry->id)}}" >
                                @csrf
                       <div class="form-group">
                           <label class="form-label" for="full-name">Name</label>
                           <div class="form-control-wrap">
                               <input name="name"  value="{{$industry->name}}" type="text" class="form-control" id="full-name" required>
                           </div>
                       </div>

                       <div class="form-group">
                           <label class="form-label">Industry: </label>
                          <textarea class="summernote-basic" name="desc">{{$industry->desc}}</textarea>
                       </div>
   ...
   @endforeach
                    ...
                    <!-- DELETE Modal Form -->
                    <div class="modal fade" tabindex="-1" id="deleteModal-{{ $industry->id}}">
                       <div class="modal-dialog" role="document">
                           <div class="modal-content">
                               <div class="modal-header">
                               ...
                               <div class="modal-body modal-body-lg text-center">
                                <div class="nk-modal">
                                    ...
                                    <h4 class="nk-modal-title">You are about to delete {{ $industry->name}} </h4>
                                    ...
                                    <div class="nk-modal-action">
                                            ...
                                            <form  method="POST" action="{{ route('deleteIndustry', $industry->id)}}" >
                                        @csrf
