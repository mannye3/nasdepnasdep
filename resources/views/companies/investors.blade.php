...
@section('content')
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Investorss</h3>
                                                ...
                                                <table class="datatable-init-export nk-tb-list nk-tb-ulist table-bordered" data-auto-responsive="false">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                <span>{{ $investor->company->name }}</span>
                                                            </td>
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <span>{{ $investor->company->type }}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md">
                                                                <span>{{ $investor->company->addr }}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md">
                                                                @if($investor->suspended == 0)
                                                                <span class="tb-status text-success">Active</span>

                                                                @endif

                                                                @if($investor->suspended == 1)
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="{{ url('investor', $investor->company_id)}}"><em class="icon ni ni-list-ol"></em><span>View</span></a></li>
                                                                                    <li><a href="" data-toggle="modal" data-target="#deleteModal-{{ $investor->company_id}}"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                ...
                <!-- DELETE Modal Form -->
                <div class="modal fade" tabindex="-1" id="deleteModal-{{ $investor->company_id}}">
                       ...
                       <div class="modal-content">
                           ...
                           <div class="modal-body modal-body-lg text-center">
                            <div class="nk-modal">
                                ...
                                <h4 class="nk-modal-title">You are about to delete {{ $investor->company->name}} ?</h4>
                                ...
                                <div class="nk-modal-action">
                                    ...
                                    <form method="POST" id="deleteModal1-{{ $investor->id}}"  action="{{ route('deleteInvestor', $investor->company_id)}}">@csrf
