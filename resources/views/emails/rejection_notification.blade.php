...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,600" rel="stylesheet" type="text/css">
     <link href="http://127.0.0.1:8000/dashboard/assets/css/dashlite.css" rel="stylesheet" type="text/css" />
    <link href="http://127.0.0.1:8000/dashboard/assets/css/theme.css" rel="stylesheet" type="text/css" />
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    ...
                                    <h2 style="font-size: 18px; color: #1ee0ac; font-weight: 400; margin-bottom: 8px;">Application Rejected.</h2>
...
<script src="http://127.0.0.1:8000/dashboard/assets/js/bundle.js"></script>
<script src="http://127.0.0.1:8000/dashboard/assets/js/scripts.js"></script>
</html>
