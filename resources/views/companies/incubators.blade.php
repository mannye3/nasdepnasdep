...
@section('content')
                                                ...
                                                <table class="datatable-init-export nk-tb-list nk-tb-ulist table-bordered" data-auto-responsive="false">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                <span>{{ $incubator->company->name }}</span>
                                                            </td>
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    <span>{{ $incubator->company->website }}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md">
                                                                <span>{{ $incubator->enterprise->count() }}</span>
                                                            </td>
                                                            <td class="nk-tb-col tb-col-md">
                                                                <span>{{ $incubator->pool->count() }}</span>
                                                            </td>
                                                                        ...
                                                                        <div class="drodown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="{{ url('incubator', $incubator->company_id)}}"><em class="icon ni ni-list-ol"></em><span>View</span></a></li>
                                                                                    <li><a href="" data-toggle="modal" data-target="#deleteModal-{{ $incubator->company_id}}"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                ...
                <!-- DELETE Modal Form -->
                <div class="modal fade" tabindex="-1" id="deleteModal-{{ $incubator->company_id}}">
                       ...
                       <div class="modal-content">
                           ...
                           <div class="modal-body modal-body-lg text-center">
                            <div class="nk-modal">
                                ...
                                <h4 class="nk-modal-title">You are about to delete {{ $incubator->company->name}} ?</h4>
                                ...
                                <div class="nk-modal-action">
                                    ...
                                    <form method="POST" id="deleteModal1-{{ $incubator->id}}"  action="{{ route('deleteIncubator', $incubator->company_id)}}">@csrf
