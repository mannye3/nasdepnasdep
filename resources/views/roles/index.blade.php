                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        ...
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalForm">Add New</button> @endcan
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="580.00">
                                                                <a class="btn btn-info" href="" data-toggle="modal" data-target="#showModal-{{ $role->id}}">Show</a>

                                                                @can('role-edit')
                                                                    <a class="btn btn-primary" href="" data-toggle="modal" data-target="#editModal-{{ $role->id}}">Edit</a>

                                                                @endcan
                                                                @can('role-delete')
                                                                    {!! Form::open(['method' => 'DELETE','route' => ['roles.destroy', $role->id],'style'=>'display:inline']) !!}
                                                                    <a class="btn btn-danger" href="" data-toggle="modal" data-target="#deleteModal-{{ $role->id}}">Delete</a>
