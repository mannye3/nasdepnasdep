...
@section('content')
 ...
 <div class="nk-content ">
                                                        ...
                                                        <tr class="nk-tb-item">
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    ...
                                                                    <div class="user-info">
                                                                       <a href="{{route('enterprisekycdetails', $kyc->id)}}"> <span class="tb-lead">{{$kyc->name}}<span class="dot dot-success d-md-none ml-1"></span></span> </a>
                                                            ...
                                                            <td class="nk-tb-col">
                                                                <div class="user-card">
                                                                    ...
                                                                    <div class="user-info">
                                                                        <span class="tb-lead">{{$kyc->user->name}}<span class="dot dot-success d-md-none ml-1"></span></span>
                                                            ...
                                                            <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                               <ul class="list-inline list-download">
                                                                <li> <a href="{{$kyc->doc}}" class="popup"><em class="icon ni ni-download"></em></a></li>

                                                            </ul>
                                                            </td>
                                                             <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                                <span class="tb-date">{{$kyc->created_at}}</span>
                                                            </td>

                                                            <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                               @if ($kyc->status == 0)
                                                                <span class="badge badge-dim badge-sm badge-outline-primary">Pending</span>
                                                                <span data-toggle="tooltip" title="Pending at {{$kyc->updated_at}}" data-placement="top"><em class="icon ni ni-info"></em></span>
                                                                @endif

                                                                 @if ($kyc->status == 1)
                                                                 <span class="badge badge-dim badge-sm badge-outline-success">Approved</span>
                                                                 <span data-toggle="tooltip" title="Approved at {{$kyc->updated_at}}" data-placement="top"><em class="icon ni ni-info"></em></span>
                                                                 @endif

                                                                  @if ($kyc->status == 2)
                                                                 <span class="badge badge-dim badge-sm badge-outline-danger">Rejected</span>
                                                                 <span data-toggle="tooltip" title="Rejected at {{$kyc->updated_at}}" data-placement="top"><em class="icon ni ni-info"></em></span>
                                                                 @endif
                                                            ...
                                                            <td class="nk-tb-col tb-col-md">
                                                                ...
                                                                <div class="user-name">
                                                                     ...
                                                                     @endif
                                                                     @if ($kyc->status == 1)
                                                                        <span class="tb-lead">{{$kyc->contractor->name}}</span>
                                                                     @endif
                                                                     @if ($kyc->status == 2)
                                                                        <span class="tb-lead">{{$kyc->contractor->name}}</span>
                                                                     @endif
                                                            ...
                                                            <td class="nk-tb-col nk-tb-col-tools">
                                                                ...
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="{{route('enterprisekycdetails', $kyc->id)}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Quick View">
                                                              ...
                                                              <li class="nk-tb-action-hidden">
                                                                    <a href="#"
                                                                                data-toggle="modal"
                                                                                data-target="#approve-{{ $kyc->id}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Approved">
                                                                        <em class="icon ni ni-check-fill-c"></em>
                                                                    </a>
                                                                </li>
                                                                <li class="nk-tb-action-hidden">
                                                                    <a data-toggle="modal"
                                                                                data-target="#reject-{{ $kyc->id}}" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Rejected">
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li><a href="{{route('enterprisekycdetails', $kyc->id)}}"><em class="icon ni ni-focus"></em><span>Quick Details</span></a></li>
   ...
   <!-- @@ organization lead Delete Modal @e -->
     @foreach ($kYCLists as $kyc)
    <div class="modal fade" id="reject-{{ $kyc->id}}">
          ...
          <div class="modal-body modal-body-sm text-center">
            <div class="nk-modal py-4">
              ...
              <div class="nk-modal-text mt-n2">
                <p class="text-soft">
                You are about to <b>Reject  {{ $kyc->name}}</b> Details.
                </p>
              </div>
              <ul class="d-flex justify-content-center gx-4 mt-4">
                <li>
                    <form  method="POST" action="{{ route('rejectKyc', $kyc->id)}}" >
                                        @csrf
    ...
    <!-- .modal -->
     ...
     <!-- @@ organization lead Delete Modal @e -->
     @foreach ($kYCLists as $kyc)
    <div class="modal fade" id="approve-{{ $kyc->id}}">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <a href="#" class="close" data-dismiss="modal"
            ><em class="icon ni ni-cross"></em
          ...
          <div class="modal-body modal-body-sm text-center">
            <div class="nk-modal py-4">
              ...
              <div class="nk-modal-text mt-n2">
                ...
                You are about to <b>Approve  {{ $kyc->name}}</b> Details.
                </p>
              </div>
              <ul class="d-flex justify-content-center gx-4 mt-4">
                <li>
                     <form  method="POST" action="{{ route('approveKyc', $kyc->id)}}" >
                                        @csrf
