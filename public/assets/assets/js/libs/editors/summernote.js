            ...
            (() => {
                    ...
                    var e = document.body.createTextRange(),
                        n = (function t(e, n) {
                            ...
                            if (dt.isText(e)) {
                                ...
                                (o = a || e.parentNode),
                                    (n += k.sum(k.tail(r), dt.nodeLength)),
                                    (i = !a);
                            } else {
                                if (((o = e.childNodes[n] || e), dt.isText(o)))
                                    return t(o, 0);
                                (n = 0), (i = !1);
                            }
                    ...
                    return (
                        ...
                        (o = [
                            ...
                            },
                            {
                                key: "expand",
                                value: function (e) {
                                    var n = dt.ancestor(this.sc, e),
                                        o = dt.ancestor(this.ec, e);
                                    if (!n && !o)
                                        return new t(
                                            this.sc,
                                            this.so,
                                ...
                                value: function () {
                                    ...
                                    if (e) {
                                        ...
                                        if (
                                            ...
                                            var r = dt.wrap(k.head(i), "p");
                                            dt.appendChildNodes(r, k.tail(i));
                                        }
                                    }
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    if (!dt.isCharPoint(n)) return this;
                                    var o = dt.prevPointUntil(n, function (t) {
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    if (o(n)) return this;
                                    var i = dt.prevPointUntil(n, o);
                                    return (
                                        e && (n = dt.nextPointUntil(n, o)),
                                        new t(
                                            i.node,
                                            i.offset,
                                            n.node,
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    var n = this.getEndPoint(),
                                        o = dt.prevPointUntil(n, function (o) {
                                            if (
                                                !dt.isCharPoint(o) &&
                                                !dt.isSpacePoint(o)
                                            )
                ...
                const bt = {
                    create: function (t, e, n, o) {
                        if (4 === arguments.length) return new gt(t, e, n, o);
                        if (2 === arguments.length)
                            return new gt(t, e, (n = t), (o = e));
                    ...
                    createFromNode: function (t) {
                        ...
                        return (
                            dt.isVoid(e) &&
                                ((n = dt.listPrev(e).length - 1),
                                (e = e.parentNode)),
                            dt.isBR(o)
                                ? ((i = dt.listPrev(o).length - 1),
                                  (o = o.parentNode))
                                : dt.isVoid(o) &&
                                  ((i = dt.listPrev(o).length),
                                  (o = o.parentNode)),
                            this.create(e, n, o, i)
                        );
                    },
                    ...
                    createFromBookmark: function (t, e) {
                        var n = dt.fromOffsetPath(t, e.s.path),
                            o = e.s.offset,
                            i = dt.fromOffsetPath(t, e.e.path),
                            r = e.e.offset;
                        return new gt(n, o, i, r);
                    },
                    createFromParaBookmark: function (t, e) {
                        var n = t.s.offset,
                            o = t.e.offset,
                            i = dt.fromOffsetPath(k.head(e), t.s.path),
                            r = dt.fromOffsetPath(k.last(e), t.e.path);
                        return new gt(i, n, r, o);
                    },
                };
                var yt = {
                    BACKSPACE: 8,
                ...
                const kt = {
                    ...
                    nameFromCode: m.invertObject(yt),
                    code: yt,
                };
                function wt(t, e) {
                    for (var n = 0; n < e.length; n++) {
                        ...
                        (o = [
                            ...
                            },
                            {
                                ...
                                value: function (t, n) {
                                    ...
                                    if (t.isCollapsed())
                                        return [t.insertNode(dt.create(o))];
                                    var a = dt.makePredByNodeName(o),
                                        s = t
                                            .nodes(dt.isText, {
                                                fullyContains: !0,
                                            })
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var n = k.head(t),
                                        o = k.last(t),
                                        i =
                                            dt.isList(n.previousSibling) &&
                                            n.previousSibling,
                                        r =
                                            dt.isList(o.nextSibling) &&
                                            o.nextSibling,
                                        a =
                                            i ||
                                            dt.insertAfter(
                        ...
                        (o = [
                            {
                                ...
                                value: function (t, e) {
                                    var n = dt.ancestor(
                                        ...
                                        o = dt.ancestor(n, dt.isTable),
                                        i = dt.listDescendant(o, dt.isCell),
                                        r = k[e ? "prev" : "next"](i, n);
                        ...
                        (o = [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    var o = kt.nameFromCode[t.keyCode];
                                    o && n.push(o);
                                    var i = e[n.join("+")];
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    var t = this.getLastRange().expand(
                                        ...
                                        n = e()(k.head(t.nodes(dt.isAnchor))),
                                        o = {
                                            range: t,
                                            text: t.toString(),
                                ...
                                value: function () {
                                    ...
                                    if (t.length) {
                                        ...
                                        if (
                                            ...
                                            bt.createFromNodeAfter(n).select();
                                        (this.lastWordRange = null),
                                            this.hide(),
                ...
                var Pe = $e(
                    ...
                    Le = $e('<div class="note-editing-area"></div>'),
                    Ae = $e(
                    ...
                    He = $e('<div class="note-editor note-airframe"></div>'),
                    ze = $e(
                        [
                            '<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>',
                            '<output class="note-status-output" role="status" aria-live="polite"></output>',
                    ...
                    Be = $e('<div class="note-btn-group btn-group"></div>'),
                    Me = $e(
                    ...
                    Oe = function (t, e) {
                        return t + " " + Ve(e.icons.caret, "span");
                    },
                    Ue = $e(
                    ...
                    Ke = $e('<div class="checkbox"></div>', function (t, e) {
                        t.html(
                            [
                                "<label" +
                                    (e.id ? ' for="note-' + e.id + '"' : "") +
