                                                ...
                                                <ul class="data-list is-compact">
                                                    ...
                                                    <li class="data-item">
                                                        <div class="data-col">
                                                            ...
                                                            <div class="data-value">{{$kycdetails->exp}}</div>
                                                        </div>
                                                    </li>
                                                    <li class="data-item">
                                                        <div class="data-col">
                                                            <div class="data-label">Industry</div>
                                                            <div class="data-value">{{$kycdetails->industry->name}}</div>
                                                        </div>
                                                    </li>
                                                    <li class="data-item">
                                                        <div class="data-col">
                                                            <div class="data-label">Growth Stage</div>
                                                            <div class="data-value">{{$kycdetails->growth_stage}}</div>
                                                        </div>
                                                    </li>
                                                    <li class="data-item">
                                                        <div class="data-col">
                                                            <div class="data-label">Type of investor required</div>
                                                            <div class="data-value">{{$kycdetails->toi}}</div>
                                                        </div>
                                                    </li>
                                                    <li class="data-item">
                                                        <div class="data-col">
                                                            <div class="data-label">Type of funding required</div>
                                                            <div class="data-value">{{$kycdetails->tof}}</div>
                                                        </div>
                                                    </li>
                                                    <li class="data-item">
                                                        <div class="data-col">
                                                            <div class="data-label">Year of last auditted</div>
                                                            <div class="data-value">{{$kycdetails->ylaf}}</div>
                                                        </div>
                                                    </li>
                                                    <li class="data-item">
                                                        <div class="data-col">
                                                             <div class="data-label">Year of last turnover</div>
                                                            <div class="data-value text-break">{{$kycdetails->ylaf_turnover}}</div>
                                                        </div>
                                                    </li>
                                                      <li class="data-item">
                                                        <div class="data-col">
                                                             <div class="data-label">Amount to be raised</div>
                                                            <div class="data-value text-break">{{$kycdetails->amount}}</div>
                                                        </div>
                                                    </li>
                                                    <li class="data-item">
                                                        <div class="data-col">
